...
const DairyContactCarousel = ({items}) => {
  const vegItems = items.filter(item => item.type === 'dairyPrdoct')
  const responsive = {
      desktop: {
  ...
  return (
    ...
    <section className='flex justify-between'>
      <h1 className='font-bold text-xl mb-2 p-3 md:p-0'>Dairy Product Contact </h1>
...
export default DairyContactCarousel